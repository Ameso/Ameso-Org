...
function SEO({ description, lang, title, path }) {
  ...
  return (
    ...
    >
      ...
      <meta property="og:title" content={amsTitle} />
      ...
      <meta name="twitter:creator" content="@AmesoProtocol"></meta>
      <meta name="twitter:site" content="@AmesoProtocol" />
      <meta property="og:image" content={`${site.siteMetadata.siteUrl}${path ? path : '/images/'}twitter-card.jpg`} />
